...
void Ted_Button_uint16::initButton(Adafruit_GFX *gfx, const char* align,
                  ...
                  uint16_t value, uint16_t minValue, uint16_t maxValue,
                  const char* zeroString, bool degreeSym,
                  uint16_t (*checkValue)(Ted_Button_uint16& btn, uint16_t value),
...
bool Ted_Button_uint16::setValue(uint16_t value, bool dontCheck) {
  if (value < _minValue)
    value = _minValue;
  if (value > _maxValue)
    value = _maxValue;
...
bool Ted_Button_uint16::setValueAndDrawIfChanged(uint16_t value, bool forceDraw) {
  setValue(value);
...
bool Ted_Button_uint16::valueIncDec(int16_t N, Ted_Button_Base* btn) {
