#ifndef _TED_BUTTON_UINT8_H
#define _TED_BUTTON_UINT8_H
/*
  Define a new button class derived from class Ted_Button, that attaches a
  uint8_t unsigned integer value to the button, its value being used as the
  button label.
*/
...
class Ted_Button_uint8 : public Ted_Button {

protected:
  uint8_t _value, _minValue, _maxValue;
  const char* _zeroString;
  uint8_t (*_checkValue)(Ted_Button_uint8& btn, uint8_t value);
...
public:
  ...
  */
  /**************************************************************************/
  Ted_Button_uint8(const char* name, Adafruit_GFX* gfx=0, const char* align="C",
                  ...
                  uint8_t (*checkValue)(Ted_Button_uint8& btn, uint8_t value) = NULL,
